...
3. The app runs for **7 days** without a key. After that, open **Help → Enter license key…** and paste the key you were sent (issued for your callsign or email). It lasts **one month** from the day you first activate it on that PC. Uninstalling and reinstalling does not restart the trial or the month.
